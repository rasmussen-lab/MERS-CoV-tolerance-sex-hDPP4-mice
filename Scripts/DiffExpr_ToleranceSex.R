...
plotMA(res1L_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="A) Day1_F: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res1H_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="B) Day1_F: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res1L_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="C) Day1_M: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res1H_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="D) Day1_M: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)

plotMA(res2L_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="A) Day2_F: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res2H_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="B) Day2_F: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res2L_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="C) Day2_M: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res2H_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="D) Day2_M: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)

plotMA(res3L_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="A) Day3_F: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res3H_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="B) Day3_F: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res3L_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="C) Day3_M: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res3H_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="D) Day3_M: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)

plotMA(res4L_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="A) Day4_F: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res4H_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="B) Day4_F: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res4L_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="C) Day4_M: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res4H_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "red", main ="D) Day4_M: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)

plotMA(res5L_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "blue", main ="A) Day5_F: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res5H_F, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "blue", main ="B) Day5_F: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res5L_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "blue", main ="C) Day5_M: LOW vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
plotMA(res5H_M, ylim=c(-2,2), cex=.6, alpha=0.05, colSig = "blue", main ="D) Day5_M: HIGH vs MOCK")
abline(h=c(-1,1), col="dodgerblue", lwd=2)
